...
/*!
@class TransposedConvolution2D  TransposedConvolution2D class
*/
...
private:
    ...
    cudnnConvolutionFwdAlgo_t m_algo; ///<  ForwardPropagate Convolution연산을 하기 위한 다양한 알고리즘을 제공하는 변수. (TransposedConvolution의 BackwardPropagete에 사용)
    cudnnConvolutionBwdFilterAlgo_t m_filterAlgo; ///< BackwardPropagate Convolution연산을 하기 위한 다양한 알고리즘을 제공하는 변수. (TransposedConvolution의 ForwardPropagate에 사용)
